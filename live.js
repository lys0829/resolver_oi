...
$(function () {
	...
	$.get(resultsBeforeUrl+result_version, function (resultsBefore) {
		$.get(resultsFinalUrl+result_version, function (resultsFinal) {
	...
	setInterval(function(){
			...
			$.get(resultsBeforeUrl+result_version, function (resultsBeforeLive) {
				$.get(resultsFinalUrl+result_version, function (resultsFinalLive) {
					/*console.log(resultsBeforeLive);
					console.log(resultsFinalLive);*/
					console.log("update");
					
					resultsBeforeLive = recalculateResults(resultsBeforeLive);
					resultsFinalLive = recalculateResults(resultsFinalLive);
					resultsBeforeLive = separateInstituteName(resultsBeforeLive);
					resultsFinalLive = separateInstituteName(resultsFinalLive);
					
					resultsBeforeLive = populatePending(resultsBeforeLive, resultsFinalLive);
					
					updateScoreboard(resultsBeforeLive);
				},"json");
			},"json");
		}
	,scoreboardUpdateTime);
